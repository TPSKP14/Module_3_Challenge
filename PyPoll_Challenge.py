...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_votes:
        ...
        votes_county_percentage = float(total_county_votes) / float(total_votes) * 100

         # 6d: Print the county results to the terminal.
        county_vote_results = (
            f"{county_name}: {votes_county_percentage:.1f}% ({total_county_votes:,})\n")
        ...
        if (total_county_votes > biggest_county_votes): 
            biggest_county_votes = total_county_votes
